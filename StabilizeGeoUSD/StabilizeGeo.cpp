// ============================================================================
//  StabilizeGeo.cpp  -  NEW 3D / USD system (ModifyGeomOp)   [v006]
//
...
//
//  v006 fix (over v005): the engine now reaches the axis input through the
//  documented GeomOpEngine accessor inputOpAt(node_input, frame), instead of a
...
//    dynamic_cast<AxisOp*> ->  validate(true) + matrix() = world xform @ frame
//
...
private:
  ...
  public:
    Engine(GeomOpNode* parent) : ModifyEngine(parent, &_filter) {}
